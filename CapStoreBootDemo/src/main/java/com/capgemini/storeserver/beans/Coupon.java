...
public class Coupon {
	...
	public String toString() {
		return "Coupon [couponId=" + couponId + ", couponStartDate=" + couponStartDate + ", couponEndDate="
				+ couponEndDate + ", couponName=" + couponName + ", couponDiscountValue=" + couponDiscountValue
				+ ", admin=" + admin + "]";
	}
	@Id
